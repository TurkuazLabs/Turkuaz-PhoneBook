...
// 📌 Modul - Go
// Version: 2.5.2
// Aciklama: Turkuaz-PhoneBook 2.5.2 launcher kimligiyle portable/installed update, kullanici tercihi override ve Java baslatma akislarini yonetir.
...
const (
	...
	launcherUserAgent       = "TurkuazPhoneBookLauncher/2.5.2"
)
