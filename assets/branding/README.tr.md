...
## Tema uyumlu marka rengi

Ana gorsel dil bagimsiz kalir. Swing yan paneli ve Hakkinda ekranindaki marka simgesi ayni alpha gorselden Light/Dark palete gore calisma aninda yeniden renklendirilir. Windows paketleme ayrica `app-icon-light.ico` ve `app-icon-dark.ico` uretir; native splash Java baslamadan once kayitli temaya uygun varyanti kullanir.
