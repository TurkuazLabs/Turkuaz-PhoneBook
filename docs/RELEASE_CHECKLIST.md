...
# 📌 Amac: Turkuaz PhoneBook v2.38.0 release oncesi ve sonrasi dogrulama adimlarini tek yerde tutar.
# 📌 Modul - Markdown
# Version: 1.0.0
...
# Turkuaz PhoneBook v2.38.0 Release Checklist
...
1. Son yesil `main` commitinde `v2.38.0` tag olustur.
2. Tag'i GitHub'a push et.
3. `Release` workflow'un tum joblarinin yesil tamamlanmasini bekle.
4. GitHub Release basliginin `Turkuaz PhoneBook v2.38.0` oldugunu dogrula.
...
- `Turkuaz-PhoneBook-Android-v2.38.0-debug.apk`
